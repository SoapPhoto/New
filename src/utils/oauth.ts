...
export function getOauthUrl(type: OauthType, state: OauthStateType) {
  let url = ''
...
export function oauthOpen(url: string) {
  const windowArea = {
...
export function oauthSuccess(e: MessageEvent, cb: (data: IOauthSuccessData) => void, ok?: () => void, error?: (data: any) => void) {
